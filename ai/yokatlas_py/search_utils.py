...
from .form_data import PROGRAMS # expand_program_name fonksiyonu için gerekli
from .onlisans_form_data import ONLISANS_PROGRAMS # expand_program_name fonksiyonu için gerekli
...
PROGRAM_EXPANSIONS = {
    ...
    "orman": ["Orman Mühendisliği", "Ormancılık"],
    "tarım": [
        "Tarım Ekonomisi",
        "Tarla Bitkileri",
        "Bahçe Bitkileri",
...
def find_best_university_match(name: str, program_type: str = "lisans") -> str:
    ...
    common_abbreviations = {
        ...
        "BAU": "BAHÇEŞEHİR ÜNİVERSİTESİ",
        "AU": "ANADOLU ÜNİVERSİTESİ",
        "AÜ": "ANADOLU ÜNİVERSİTESİ",
